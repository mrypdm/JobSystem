...
cp ../../Certificates/kafka/svc_kafka/svc_kafka.p12 kafka/secrets/
cp ../../Certificates/kafka/kafka.p12 kafka/secrets/
...
sudo chmod 400 kafka/secrets/kafka.p12
...
cp ../../Certificates/kafka/superuser/superuser.p12 kafka-ui/secrets/
cp ../../Certificates/kafka/kafka.p12 kafka-ui/secrets/
...
sudo chmod 400 kafka-ui/secrets/kafka.p12
